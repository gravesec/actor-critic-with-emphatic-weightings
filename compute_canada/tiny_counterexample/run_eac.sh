...
alpha_w=(0.0000000001 0.00000001)
lamda=(0.0 0.5 1.0)
...
parallel --jobs 4 --progress python scripts/tiny_counterexample/run_eac.py ::: ${bias_unit[@]} ::: ${alpha_u[@]} ::: ${alpha_v[@]} ::: ${alpha_w[@]} ::: ${lamda[@]} ::: ${lamda_a[@]} ::: ${gamma[@]} ::: ${run[@]} ::: ${num_eval_points[@]}
