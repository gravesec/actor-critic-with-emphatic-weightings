...
if __name__ == '__main__':
    ...
    parser.add_argument('--start_pos', type=int, default=0, help='Start pos sweep')
...
cd ..
source ~/python_ace/bin/activate
python {args.script_name} \\
--output_dir \'{args.output_dir}/{script_num}\' \\
