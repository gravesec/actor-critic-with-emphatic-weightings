...
if __name__ == '__main__':
    ...
    parser.add_argument('--environment', type=str, choices=['CartPole-v0', 'MountainCar-v0', 'Acrobot-v1', 'PuddleWorld-v0'], default='MountainCar-v0', help='The environment to generate experience from.')
