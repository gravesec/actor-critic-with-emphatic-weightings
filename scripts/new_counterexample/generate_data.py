...
from src.misc_envs.mdps import new_counterexample_env

# Set up the experiment:
environment_name = 'new_counterexample' # TODO: Figure out how to register these environments in gym.
max_num_timesteps = 1000
num_actions = 2
behaviour_policy_name = 'random'
behavior_probs = [0.7,0.3]
...
if __name__ == '__main__':
    ...
    env = new_counterexample_env().to_env()
    ...
    for episode_num in range(args.num_episodes):
        ...
        # Store the episode:
        episodes.append(np.array(transitions, dtype=[('s', float, 1), ('a', int, 1), ('r_prime', float, 1), ('s_prime', float, 1)]))
