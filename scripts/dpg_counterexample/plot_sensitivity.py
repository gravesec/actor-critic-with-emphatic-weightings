...
plt.ylabel('$J_\mu$', fontsize=16, rotation=0, labelpad=15)
plt.xticks(fontsize=24)
plt.yticks(fontsize=24)
#plt.ylim(0.7, 1.27)
linewidth = 3
# plt.title('$\mu(A_0) = $ {}, number of episodes: {}'.format(behavior_params[0], last_episode))
...
plt.xscale('log')
print(ax.get_xticks()[2:-1:2])
ax.set_xticks(ax.get_xticks()[2:-2:2])
plt.tight_layout()
# plt.legend()
plt.show()
