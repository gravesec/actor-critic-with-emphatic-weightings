...
if __name__ == '__main__':
    ...
    agent = EAC(None, tc.num_features, args.alpha_u, args.alpha_v, args.alpha_w, args.lamda, args.lamda_a, policy_type='continuous')
    # print(agent.actor.policy.u)
    ...
    for episode_num, episode in enumerate(episodes):
        ...
        for t, transition in enumerate(episode):
            ...
            b_t = scipy.stats.norm.pdf(a_t, behavior_params[0], behavior_params[1])#behavior_probs[a_t]#1. / num_actions # don't assume equiprobable random behaviour policy
            rho_t = 1.0 / b_t # pi_t in the IS ratio cancels with pi_t in the denominator of grad_log
            # print('--')
            # print(a_t, pi_t, b_t)
            # print('rho_t:', rho_t)
